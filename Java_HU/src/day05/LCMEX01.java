...
public class LCMEX01 {
	...
	public static void main(String[] args) {
		 ...
		 * 		  => i를 num1로 나누었을 때 나머지가 0과 같고 i를 num2로 나누었을 때 나머지가 0과 같다면 i를 출력한 후 반복문 종료
		 * 반복문 종료 후 : 없음
		 * */
		...
		for(i = 1; ;i++) {
			...
			System.out.println(num1 + "와" + num2 + "의 최소 공배수는" + i);
				break;
			}
		}
		// num1이 num2보다 작으면 num1과 num2를 바꾸는 코드(두 수를 바꾸는 코드는 자주 사용함)
